...
export function Adsorbentes({ products }: { products: ProductsResponse[] }) {

      return (
            <>
                  <PhibroNavegation back={"/catalogo/2"} nextStep={"catalogo/4"} position={false} />
  ...
  className="-mt-40"
                              whileTap={{ scale: 0.90 }}
                        >
                              <PhibroButton title={"ADSORBENTES Y MINERALES"} variant={false} index={4} link={"/catalogo/3"} />
                        </motion.div>
